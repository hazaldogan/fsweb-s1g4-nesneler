...
console.log(MenuElemaniOlustur("Kaşarlı Tost",8,"Tostlar"))
...
const burger = {
	...
	indirim: function(unvan){
		let fiyat = this.fiyat;
		if(unvan === "öğretmen" || unvan === "öğrenci"){
			fiyat *= 0.75
		}else {fiyat *= 0.9}
		return fiyat
	}
...
function DegerlendirmeEkle(dizi,arg1,arg2,arg3){
	dizi.push({
		isim:arg1,
		puan:arg2,
		geribildirim:arg3
